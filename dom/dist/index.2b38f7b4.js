...
})({"xDTwo":[function(require,module,exports) {
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d751713988987e9331980363e24189ce";
module.bundle.HMR_BUNDLE_ID = "31f61d2ea9e3c82fcb4d41fd2b38f7b4"; // @flow
...
},{}],"2nL4U":[function(require,module,exports) {
// 对象模式封装dom的api
// 我们这次实现的封装是按照对象风格实现
// 因此建议熟悉一下js对象的语法特征。
window.dom = {
    ...
    text (node, string) {
        if (arguments.length === 1) {
            if ('ineerText' in node) return node.innerText;
            else return textContent;
        } else if (arguments.length === 2) {
            // innerText 支持ie
            // 这种判断的代码写法叫做适配
            if ('ineerText' in node) node.innerText = string;
            else // 用textContent 支持firefox chrome
...
},{}]},["xDTwo","2nL4U"], "2nL4U", "parcelRequire427e")

//# sourceMappingURL=index.2b38f7b4.js.map
